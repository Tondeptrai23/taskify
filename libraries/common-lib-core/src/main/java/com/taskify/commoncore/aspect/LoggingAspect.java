...
public class LoggingAspect {
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        log.info("[BEFORE] Method {} called with arguments {}", joinPoint.getSignature().getName(), joinPoint.getArgs());
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable exception) {
        log.error("[ERROR] Method {} threw exception {}", joinPoint.getSignature().getName(), exception);
    }
}
