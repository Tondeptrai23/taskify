...
import com.taskify.auth.old.dto.auth.AuthTokens;
import com.taskify.auth.old.dto.auth.RegisterRequest;
import com.taskify.auth.old.dto.user.CreateUserDto;
import com.taskify.auth.old.entity.User;
import com.taskify.auth.old.exception.EmailAlreadyExistsException;
import com.taskify.auth.old.exception.InvalidCredentialException;
import com.taskify.commoncore.error.exception.UnauthorizedException;
import com.taskify.auth.old.exception.UsernameAlreadyExistsException;
import com.taskify.auth.old.mapper.UserMapper;
import com.taskify.auth.old.repository.UserRepository;
